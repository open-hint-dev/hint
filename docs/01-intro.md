...
| [`@openhint/adapter-typescript`](../applications/adapter-typescript/README.md) | The TypeScript language adapter, so `hint verify` checks shape rather than presence. |
