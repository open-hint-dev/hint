...
1. If no `hint.yml` exists, asks for a project name and description and offers to register the default hintbook (`npm://@openhint/hintbooks-software-engineer`), then writes `hint.yml`.
...
hint install -g @openhint/hintbooks-lawyer
